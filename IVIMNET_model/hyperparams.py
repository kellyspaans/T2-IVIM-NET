...
class train_pars:
    def __init__(self,nets):
        ...
        self.freeze_T2 = False # segmented-fit in which we freeze part of the network
        self.stages = 1 # number of stages used in freeze-fitting (if regular training loop, set to 1)
    ...
    def __init__(self,nets):
        ...
        if (nets == 'optim'):
            ...
            if self.tri_exp:
                ...
                print('T2 IS SET TO TRUE!')
                if self.fix_T2p:
                    self.cons_min = [0, 0, 0, 0, 0.04]  # Dt, Fp, Ds, S0, T2t
                ...
                self.cons_max = [0.003, 0.7, 0.05, 2.5]  # Dt, Fp, Ds, S0
            ####
...
class sim:
    def __init__(self):
        ...
        self.num_samples_eval = 10000 # number of simualtions te evaluate. This can be lower than the number run. Particularly to save time when fitting. More simulations help with generating sufficient data for the neural network
